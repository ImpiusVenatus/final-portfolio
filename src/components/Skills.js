...
const Skill = ({name, x, y}) => {
    return (
        ...
        rounded-full font-semibold bg-dark text-light py-3 px-6 shadow-dark 
  ...
  return (
    <>
        ...
        sm:bg-circularLightSm sm:dark:bg-circularDarkSm">
            <motion.div className="flex items-center justify-center 
            rounded-full font-semibold bg-dark text-light p-8 shadow-dark cursor-pointer dark:text-dark dark:bg-light lg:p-6 md:p-4 xs:text-xs xs:p-2"
            whileHover={{scale:1.05}}>
                Web
            </motion.div>
            ...
            <Skill name="Authentication" x="-25vw" y="18vw" />
