...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Sadman Hossain | Portfolio</title>
        <meta name="description" content="Generated by create next app" />
      </Head>
      <TransitionEffect />
      <main className="z-100 flex items-center text-dark w-full min-h-screen dark:text-light">
          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                ...
                hover:dark:text-light hover:dark:border-light md:px-4 md:text-base" 
                download={true}>
                  Resume 
                  <LinkArrow className={"w-6 ml-1"} />
                </Link>
                <Link href="mailto:hossainsadman39@gmail.com" target={"_blank"}
        ...
        <div className="absolute right-8 bottom-8 inline-block w-24 md:hidden">
          <Image src={lightBulb} alt="SadmanHossain" className='w-full h-auto' />
        </div>
      </main>
